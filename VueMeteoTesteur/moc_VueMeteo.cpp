...
static const char qt_meta_stringdata_VueMeteo[] = {
    "VueMeteo\0"
};
...
const QMetaObjectExtraData VueMeteo::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VueMeteo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VueMeteo,
      qt_meta_data_VueMeteo, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VueMeteo::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VueMeteo))
